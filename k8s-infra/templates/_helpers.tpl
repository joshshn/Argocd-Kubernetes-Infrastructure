...
{{ include "k8s-infra.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "k8s-infra.selectorLabels" -}}
...
*/}}
{{- define "k8s-infra.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "k8s-infra.fullname" .) .Values.serviceAccount.name }}
{{- else }}
